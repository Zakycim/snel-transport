...
public class ProductControllerTest {
    ...
    String orderURL = "http://localhost:8080/snel-transport/api/products";
    ...
    public void testGetAllProducts() {
        ...
        int allProducts = pfacade.getAllProducts().size();

        assertTrue("Previous (" + allProducts + ") should be greater than (" + 1 + ")", jsonArray.size() > 1);
