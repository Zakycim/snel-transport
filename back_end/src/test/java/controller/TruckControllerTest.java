...
public class TruckControllerTest {
	...
	TruckFacade tFacade = new TruckFacade();
	String URL = "http://localhost:8080/snel-transport/api/trucks";
	...
	public void testGetAllTrucks() {
		...
		int trucks = tFacade.findAll().size();

		assertTrue("Previous (" + jsonArray.size() + ") should be equal to (" + 1 + ")", jsonArray.size() > 1);
